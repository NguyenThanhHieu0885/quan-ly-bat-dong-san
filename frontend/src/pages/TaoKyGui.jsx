...
export default function TaoKyGui() {
  ...
  const darkTheme = {
    ...
    form: { backgroundColor: '#2c2c2c', padding: '35px 1px', borderRadius: '12px', boxShadow: '0 10px 10px rgba(0,0,0,0.2)' },
          ...
          <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div style={{marginTop: '15px'}}>
              ...
              <select name="bdsid" value={formData.bdsid} onChange={handleChange} required style={darkTheme.input}>
                ...
                {danhSachBDS.map(bds => (
                  <option key={bds.bdsid} value={bds.bdsid}>{bds.bdsid}</option>
                ))}
              </select>
            </div>
            <div style={{marginTop: '15px'}}>
              <label style={darkTheme.label}>Giá trị Hợp Đồng (VNĐ) (*):</label>
              <input type="text" name="giatri" value={formData.giatri} onChange={handleChange} required style={darkTheme.input} placeholder="Ví dụ: 3,500,000,000" />
            </div>
            <div style={{marginTop: '15px'}}>
              <label style={darkTheme.label}>Chi Phí Dịch Vụ (VNĐ) (*):</label>
              <input type="text" name="chiphidv" value={formData.chiphidv} onChange={handleChange} required style={darkTheme.input} placeholder="Ví dụ: 50,000,000" />
            </div>
            <div style={{marginTop: '15px'}}>
