        ...
        <form onSubmit={handleSubmit}>
          <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div style={{marginTop: '15px'}}>
              ...
              <input type="text" name="giatri" value={formData.giatri} onChange={handleChange} required style={darkTheme.input} />
            </div>
            <div style={{marginTop: '15px'}}>
              <label style={darkTheme.label}>Chi Phí Dịch Vụ (VNĐ) (*):</label>
              <input type="text" name="chiphidv" value={formData.chiphidv} onChange={handleChange} required style={darkTheme.input} />
            </div>
            <div style={{marginTop: '15px'}}>
