...
export default function AdminLayout() {
  ...
  let userData = { 
    tennv: "Người dùng", 
    role: roleStored || "guest" // Ưu tiên lấy role từ key 'role' riêng lẻ
  };

  if (userStr) {
    try {
      const parsed = JSON.parse(userStr);
      // Gộp dữ liệu từ object user và key role bên ngoài vào một chỗ
      userData = { ...parsed, role: roleStored || parsed.role };
    } catch (e) {
